...
from models.prediction.features.flow_imbalance import read_flow_imbalance
...
def add_slippage_imbalances(
    ...
    for exchange in exchange_set.all_exchanges():
        feature_name: str = get_feature_name(
            feature=Feature.SLIPPAGE_IMBALANCE, exchange=exchange, window=window, prefix=prefix
        )
